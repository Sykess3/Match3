...
namespace _Project.Code.Core.Models
{
    public class Board : IModel
    {
        ...
        public event Action<Cell> CellContentMatched;
        public event Action<Cell> CellContentStartedMovement;
        ...
        public bool IsAnyContentMoving() => 
            _cells.Any(x => x.Value.Content.IsFalling);
        ...
        private void SubscribeOnCellEvents()
        {
            ...
            {
                cellKvP.Value.ContentRemoved += OnCellContentRemoved;
        ...
        private void OnCellContentStartedMovement(object sender, EventArgs eventArgs)
        {
            ...
            CellContentStartedMovement?.Invoke(cell);
        }

        private void OnCellContentRemoved(object sender, EventArgs e)
        {
            var cell = (Cell) sender;
            CellContentMatched?.Invoke(cell);
        }
    }
}